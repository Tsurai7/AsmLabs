...
dexs dw 10 
double dw 2h
CountMessage db "Length of arr: ", 0Ah, 0Dh, '$'
MinBorderMess db 0Ah, 0Dh, "Enter min value", 0Ah, 0Dh, '$'
MaxBorderMess db 0Ah, 0Dh, "Enter max value", 0Ah, 0Dh, '$'
MaxLessMin db 0Ah, 0Dh, "Error: max cannot be less than min" , 0Ah, 0Dh, '$' 
